...
# Required
DEVELOPER_TOKEN='149EM0MSD9383201' # Universal token for sandbox
...
CLIENT_ID='b74f7940-b454-406d-8c2b-dc7e60970cb7'
CLIENT_STATE=''
CLIENT_SECRET='~8Banm1Lre5~wyA4Er~JKf6ngly_41Z0B0'
...
def authenticate_with_oauth(authorization_data):
    ...
    authentication=OAuthWithAuthorizationCode(
        client_id=CLIENT_ID,
...
def request_user_consent(authorization_data):
    #authorization_data.authentication. redirection_uri('http://127.0.0.1:5000/')
